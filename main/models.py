...
class Warehouse(models.Model):
    ...
    opened = models.DateTimeField(verbose_name="Склад открыт", default=datetime.datetime.now)
    closed = models.DateTimeField(verbose_name="Склад будет закрыт", default=now_plus_month)
